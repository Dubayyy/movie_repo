        ...
        <div class="row mb-4">
            <div class="col-12">
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= base_url('movies') ?>">Popular</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('movies/now-playing') ?>">Now Playing</a>
                    </li>
                                ...
                                <div class="d-flex justify-content-between">
                                    <?php if(isset($movie['genre_ids']) && !empty($movie['genre_ids'])): ?>
                                        <span class="badge badge-custom">
                                            <?php 
                                            // Simplified genre mapping - in a real app, you'd fetch these from API
                                            $genres = [
                                                28 => 'Action',
                                                12 => 'Adventure',
                                                16 => 'Animation',
                ...
                <div class="col-12">
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center">
                            <?php if($page > 1): ?>
                                <li class="page-item">
                                    <a class="page-link" href="<?= base_url('movies?page=' . ($page - 1)) ?>" aria-label="Previous">
                            ...
                            <?php if($page < $movies['total_pages']): ?>
                                <li class="page-item">
                                    <a class="page-link" href="<?= base_url('movies?page=' . ($page + 1)) ?>" aria-label="Next">
